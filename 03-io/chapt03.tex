...
\caption{\java{System.out.println} refers to the \java{out} variable of the \java{System} class,
\\ which is a \java{PrintStream} that provides a method called \java{println}.}
\end{figure}
