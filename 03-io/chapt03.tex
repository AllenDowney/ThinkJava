...
We can automate the process of entering test input and comparing {\em expected output} with {\em actual output} using the command-line.
...
The first one redirects the contents of the file to \java{System.in}, as if it were the keyboard.
The second one redirects the contest of \java{System.out} to the file, as if it were the screen.
