...
Instead, it uses the variables {\tt row} and {\tt col} to represent the exact positions in the table by name.
...
Local variables cannot be accessed from outside their home method and do not interfere with any other methods.
