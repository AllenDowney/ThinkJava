...
\item Write a method called {\tt multadd} that takes three {\tt doubles} as parameters and that returns their multaddization.
...
Write a method called {\tt ack} that takes two {\tt int}s as parameters and returns the value of the Ackermann function.
...
\item Write a method called {\tt printString} that takes a String as a parameter and prints the letters of the String, one on each line.  It should be a {\tt void} method.
